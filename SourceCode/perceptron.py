...
print("step 4: feature scaling, normalization,  model Classification ==>Perceptron")
print("================================")
total = 0
accuracy = []
for i in range(10):
...
Y = data.loc[:,'Class'].values
print('')    
print("step 4.2: feature scaling, normalization,  model Classification ==>Perceptron")
print("================================")
total = 0
top5_accuracy= []
for i in range(10):
